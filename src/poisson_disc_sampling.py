# Code taken from https://www.labri.fr/perso/nrougier/from-python-to-numpy/code/Bridson_sampling.py
...
def poisson_disc_samples(width=1.0, height=1.0, radius=0.025, k=30):
